    ...
    <>
      <div style={comment_box}>
        <img
          ...
          alt="avatar"
        />
        <input style={comment_style} value={elem.name} />
        <div style={bottom_div}>
          <button
            onClick={() => onLikingComment(elem.id)}
            // style={like ? liked_style : button_style}
          >
            {like.val ? <>Liked</> : <>Like</>}
          </button>
          <button onClick={onReply} style={button_style}>
            Reply
          </button>
